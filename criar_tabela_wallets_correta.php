...
try {
    ...
    // Dropa a tabela wallets se existir
    $pdo->exec("DROP TABLE IF EXISTS wallets");
    
    // Cria a tabela wallets
    ...
    // Executa o SQL
    $pdo->exec($sql);
    echo "Tabela 'wallets' criada com sucesso!\n";
    
    // Verifica se a tabela foi criada
    $result = $pdo->query("SHOW TABLES LIKE 'wallets'");
    if ($result->rowCount() > 0) {
        echo "Verificação: A tabela 'wallets' existe no banco de dados.\n";
